...
register("dc.law.mc.edu", DigitalCommonsIssueArticleHopAdapter)
register("law.laverne.edu", WordPressAcademicBaseAdapter)
...
register("commons.lib.niu.edu", DSpaceAdapter)
